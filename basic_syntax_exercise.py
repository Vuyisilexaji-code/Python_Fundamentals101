...
c = ("10 belongs to <class 'int'>: meaning it is an integer.")
print(c)

# Edit the code below to print:
    # " 20.5 belongs to <class 'float'>: meaning it is a float."
d = (" 20.5 belongs to <class 'float'>: meaning it is a float.")
print(d)

# Edit the code below to print:
    # " 'Hello, World!', belongs to <class 'str'>: meaning it is a string."
e = (" 'Hello, World!', belongs to <class 'str'>: meaning it is a string.")
print(e)
